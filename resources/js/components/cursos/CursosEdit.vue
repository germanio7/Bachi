		        ...
		        <div class="card-content">
	          	<div class="row">
				          ...
				          <div class="radio-group" required>
											...
											<input type="radio" v-model="edit_curso.curso" value="1º" id="c1" />
											<label for="c1"><b>1º</b></label>

											<input type="radio" v-model="edit_curso.curso" value="2º" id="c2" />
											<label for="c2"><b>2º</b></label>

											<input type="radio" v-model="edit_curso.curso" value="3º" id="c3" />
											<label for="c3"><b>3º</b></label>

											<input type="radio" v-model="edit_curso.curso" value="4º" id="c4" />
											<label for="c4"><b>4º</b></label>

											<input type="radio" v-model="edit_curso.curso" value="5º" id="c5" />
				        ...
				        <div class="col m6 s12">
									<h6><b>División: </b></h6>
				          <div class="radio-group" required>
										<input type="radio" v-model="edit_curso.division" value="1ª" id="d1" />
										<label for="d1"><b>1ª</b></label>

										<input type="radio" v-model="edit_curso.division" value="2ª" id="d2" />
										<label for="d2"><b>2ª</b></label>

										<input type="radio" v-model="edit_curso.division" value="3ª" id="d3" />
										<label for="d3"><b>3ª</b></label>

										<input type="radio" v-model="edit_curso.division" value="4ª" id="d4" />
										<label for="d4"><b>4ª</b></label>

										<input type="radio" v-model="edit_curso.division" value="5ª" id="d5" />
										<label for="d5"><b>5ª</b></label>

										<input type="radio" v-model="edit_curso.division" value="6ª" id="d6" />
										<label for="d6"><b>6ª</b></label>

										<input type="radio" v-model="edit_curso.division" value="7ª" id="d7" />
				        ...
				        <div class="col m6 s12 offset-m2">
									<h6><b>Turno: </b></h6>
				          <div class="radio-group" required>
										<input type="radio" v-model="edit_curso.turno" value="Mañana" id="mañana" />
										<label for="mañana"><b>Mañana</b></label>

										<input type="radio" v-model="edit_curso.turno" value="Tarde" id="tarde" />
										<label for="tarde"><b>Tarde</b></label>

										<input type="radio" v-model="edit_curso.turno" value="Noche" id="noche" />
