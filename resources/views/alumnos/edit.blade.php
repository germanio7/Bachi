...
@section('contenido')
	...
	{!! Form::open(['action' => (['AlumnosController@update',$alumno->id]),'method'=>'POST','file'=>'true','enctype'=>'multipart/form-data','class'=>'form']) !!}
		     	...
		     	<div id="alumno" class="container" style="display: block;">
					...
					<div class="row">
						<div class="input-field col m4 s12">
	          				<input id="cuil" type="text" class="validate" name="cuil" value="{{$alumno->cuil}}">
					...
					<div class="row">
						<div class="input-field col m6 s12">
	          				<input id="apellido" type="text" class="validate" name="apellido" value="{{$alumno->apellido}}">
	          				<label for="apellido">Apellidos</label>
    					</div>

						<div class="input-field col m6 s12">
	          				<input id="nombre" type="text" class="validate" name="nombre" value="{{$alumno->nombre}}">
					...
					<div class="row">
						<div class="input-field col m4 s12">
	          				<input id="nacimiento" type="text" class="datepicker" name="fecha_nacimiento" value="{{$alumno->fecha_nacimiento}}">
	          				<label for="nacimiento">Fecha de Nacimiento</label>
        				</div>
        				<div class="input-field col m4 s12">
	          				<input id="lugar" type="text" class="validate" name="lugar_nacimiento" value="{{$alumno->lugar_nacimiento}}">
	          				<label for="lugar">Lugar de Nacimiento</label>
        				</div>
        				<div class="input-field col m4 s12">
	          				<input id="nacionalidad" type="text" class="validate" name="nacionalidad" value="{{$alumno->nacionalidad}}">
					...
					<div class="row">
						<div class="input-field col m4 s12">
	          				<input id="domiciolio" type="text" class="validate" name="direccion" value="{{$alumno->direccion}}">
	          				<label for="domiciolio">Domicilio</label>
    					</div>
        				<div class="input-field col m4 s12">
	          				<input id="barrio" type="text" class="validate" name="barrio" value="{{$alumno->barrio}}">
	          				<label for="barrio">Barrio</label>
        				</div>
        				<div class="input-field col m4 s12">
	          				<input id="departamento" type="text" class="validate" name="departamento" value="{{$alumno->departamento}}">
...
=======
							        <input name="pueblo_originario" type="radio" value="0" @if($alumno->asignacion_universal == 0) checked @endif/>
							        <span></span>
							      </label>
>>>>>>> 36b32d22cd8cdcff7f25b23d584759de12abf793
		                    </td>
...
>>>>>>> 36b32d22cd8cdcff7f25b23d584759de12abf793
		      	...
		      	<div id="tutor" style="display: none;">
					...
					<div class="container">
			      		...
			      		<div class="row">
							<div class="input-field col m4 s12">
		          				<input id="cuil_tutor" type="text" class="validate" name="cuil_tutor" value="">
						...
						<div class="row">
							<div class="input-field col m6 s12">
		          				<input id="apellido_tutor" type="text" class="validate" name="apellido_tutor" value="">
		          				<label for="apellido_tutor">Apellidos</label>
	        				</div>

							<div class="input-field col m6 s12">
		          				<input id="nombre_tutor" type="text" class="validate" name="nombre_tutor" value="">
						...
						<div class="row">
							<div class="input-field col m4 s12">
		          				<input id="fecha_nacimiento_tutor" type="text" class="datepicker" name="fecha_nacimiento_tutor" value="">
		          				<label for="fecha_nacimiento_tutor">Fecha de Nacimiento</label>
	        				</div>
	        				<div class="input-field col m4 s12">
		          				<input id="lugar_nacimiento_tutor" type="text" class="validate" name="lugar_nacimiento_tutor" value="">
		          				<label for="lugar_nacimiento_tutor">Lugar de Nacimiento</label>
	        				</div>
	        				<div class="input-field col m4 s12">
		          				<input id="nacionalidad_tutor" type="text" class="validate" name="nacionalidad_tutor" value="">
